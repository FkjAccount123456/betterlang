...
估计还是要写的，但是还是尽量少一点吧（
## 3
（错的，不要看这一行了gcc一点问题没有，还是我的问题）内存问题，两天查不出来，结果是gcc的问题，换clang就行了。、、、
## 4
...
# 2024-7-2
14:26 fac测试跑过了
15:44 目前所有测试都没问题，该开始加入内置函数和Object了

# 2024-7-3
## 1
大概完成了，到现在整个项目（betterlang-v1）所有文件两千八百多行，还没算上报废的两版GC
本以为1000行完事的
算上betterlang-v0r1项目已经进行了快一个月，以前我好像没有一个作品不间断不分心坚持这么长时间
总代码量超6000行
不错，是小项目，但是已经是我能掌控程度的极限了
## 2
betterlang v1编写过程大概是这样的
- 最初：这不是简单至极，Vim也顺手的很，几天就能完
- 写GC的时候：一个最简单的标记清除GC怎么可能要重写2遍还写不出来？！
- 接着：词法分析和编译都是我写烂的，赶紧完事
- 调试的时候：一个Bug两天解决不了？
- 完成：那就完成了吧（
